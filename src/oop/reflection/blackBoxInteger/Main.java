...
public class Main {
	...
	public static void main(String[] args)
		...
		final Constructor<BlackBoxInt> declaredConstructor = BlackBoxInt.class.getDeclaredConstructor(int.class);
		declaredConstructor.setAccessible(true);

		final BlackBoxInt blackBoxInt = declaredConstructor.newInstance(0);
