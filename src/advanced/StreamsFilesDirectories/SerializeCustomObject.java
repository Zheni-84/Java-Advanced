...
public class SerializeCustomObject {
	...
	public static void main(String[] args) {
		...
		try(ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("src/advanced.resources/course.ser"));
				ObjectInputStream ois = new ObjectInputStream(new FileInputStream("src/advanced.resources/course.ser"))){
